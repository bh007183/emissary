      ...
      <div id="editContain">
        ...
        <div className="centerFlex editAccountInput">
          <input
            ...
            data-id={"firstName"}
            ref={(element) => (fn.current = element)}
            disabled={true}
        ...
        <div className="centerFlex editAccountInput">
          <input
            ...
            data-id={"lastName"}
            ref={(element) => (ln.current = element)}
            disabled={true}
            value={user.lastName}
          ></input>
          <IconButton onClick={editLN}>
            <EditIcon />
          </IconButton>
        </div>
        <div className="centerFlex editAccountInput">
          <input
            ...
            placeholder="Email"
            data-id={"email"}
            ref={(element) => (em.current = element)}
            disabled={true}
            value={user.email}
          ></input>
          <IconButton onClick={editEM}>
            <EditIcon />
          </IconButton>
        </div>
        <div className="centerFlex editAccountInput">
          <input
            ...
            data-id={"newPassword"}
            ref={(element) => (pw.current = element)}
            disabled={true}
          ></input>
          <IconButton onClick={editPW}>
            <EditIcon />
          </IconButton>
        </div>
